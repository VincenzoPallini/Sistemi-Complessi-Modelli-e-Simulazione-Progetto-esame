...
to initialize-room
  ...
  if (Posizione_uscita = "Angolo") [
    import-pcolors "images/base1.png"
    if (obstacle = true)[import-pcolors "images/base1_obstacle2.png"]

  ]
  if (Posizione_uscita = "Centrale") [
    import-pcolors "images/base2.png"
    if (obstacle = true)[import-pcolors "images/base2_obstacle.png"]
...
to go
  ...
  foreach sorted-turtles [ x -> ask x [
    ...
    ;;Calcolo LPP (setup in-cone 6 30)
    let front-patches patches in-cone 5 30
